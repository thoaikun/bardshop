        ...
        <div className="product-detail grid">
            ...
            <div className="product-highlight">
                ...
                <div className="product-highlight__feature mb-4">
                    ...
                    <ul>
                        {product?.hf1 ? <li>{product.hf1}</li> : ''}
                        {product?.hf2 ? <li>{product.hf2}</li> : ''}
                        {product?.hf3 ? <li>{product.hf3}</li> : ''}
                        {product?.hf4 ? <li>{product.hf4}</li> : ''}
                    </ul>
                    <p className="fs-4">
                        Price: 
                ...
                <div className="product-buyform">
                    ...
                    <div className="product-buyform__button mb-3">
                        ...
                        <div 
                            ...
                            onClick={() => {
                                if (login)
                                    handleAddToCart(id, product?.name, product?.brand, imgs, product?.price, quantity)
                            }}
                        >
                            Add to cart
                        </div>
